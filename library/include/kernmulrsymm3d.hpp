...
class kernmulrsymm3d_kernel {
	public:
	    using read_accessor =
		    sycl::accessor<dataT, 1, sycl::access::mode::read, sycl::access::target::global_buffer>;
	    using write_accessor =
		    sycl::accessor<dataT, 1, sycl::access::mode::read_write, sycl::access::target::global_buffer>;
		kernmulrsymm3d_kernel(write_accessor fftMxPtr, write_accessor fftMyPtr, write_accessor fftMzPtr,
...
template <typename dataT>
void kernmulrsymm3d_async(sycl::queue funcQueue,
    ...
    funcQueue.submit([&] (sycl::handler& cgh) {
        ...
        auto fftKyz_acc = fftKyz->template get_access<sycl::access::mode::read>(cgh);
        auto fftKxz_acc = fftKxz->template get_access<sycl::access::mode::read>(cgh);
        ...
        cgh.parallel_for(sycl::nd_range<3>(sycl::range<3>(gsize[0], gsize[1], gsize(2)),
		                 ...
		                 kernmulrsymm3d_kernel<dataT>(fftMx_acc, fftMy_acc, fftMz_acc,

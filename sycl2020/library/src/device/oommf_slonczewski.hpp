...
void addoommfslonczewskitorque_fcn(size_t totalThreads, sycl::nd_item<1> item,
...
template <typename dataT>
void addoommfslonczewskitorque_t(size_t blocks, size_t threads, sycl::queue q,
                 dataT*         tx, dataT*             ty, dataT* tz,
    ...
    libMumax3clDeviceFcnCall(addslonczewskitorque_fcn<dataT>, totalThreads, threads,
                                     tx,             ty, tz,
                                     mx,             my, mz,
                                     Ms,         Ms_mul,
                                     jz,         jz_mul,

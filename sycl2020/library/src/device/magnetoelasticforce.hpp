...
void getmagnetoelasticforce_fcn(sycl::nd_item<3> item,
...
template <typename dataT>
void getmagnetoelasticforce_t(size_t blocks[3], size_t threads[3], sycl::queue funcQueue,
                              dataT*  fx, dataT*    fy, dataT*  fz,
                              dataT*  mx, dataT*    my, dataT*  mz,
                              dataT* B1_, dataT B1_mul,
                              dataT* B2_, dataT B2_mul,
    ...
    q.parallel_for(sycl::nd_range<3>(sycl::range<3>(blocks[0]*threads[0], blocks[1]*threads[1], blocks[2]*threads[2]),
        ...
        [=](sycl::nd_item<3> item){
        getmagnetoelasticforce_fcn<dataT>(item,
                                            fx,     fy,   fz,
                                            mx,     my,   mz,
                                           B1_, B1_mul,
                                           B2_, B2_mul,

...
void lltorque2_fcn(size_t totalThreads, sycl::nd_item<1> item,
...
template <typename dataT>
void lltorque2_t(size_t blocks, size_t threads, sycl::queue q,
                   dataT*  tx, dataT*  ty, dataT*  tz,
                   dataT* mx_, dataT* my_, dataT* mz_,
                   dataT* hx_, dataT* hy_, dataT* hz_,
                   dataT* alpha_, dataT alpha_mul,
    ...
    libMumax3clDeviceFcnCall(lltorque2_fcn<dataT>, totalThreads, threads,
                             tx, ty, tz,
                             mx_, my_, mz_,
                             hx_, hy_, hz_,
                             alpha_, alpha_mul,

...
void adduniaxialanisotropy2_fcn(size_t totalThreads, sycl::nd_item<1> item,
...
template <typename dataT>
void adduniaxialanisotropy2_t(size_t blocks, size_t threads, sycl::queue q,
                              dataT* BX, dataT* BY, dataT* BZ,
    ...
    libMumax3clDeviceFcnCall(adduniaxialanisotropy2_fcn<dataT>, totalThreads, threads,
                             BX, BY, BZ,
                             mx, my, mz,
                             Ms_, Ms_mul,
                             k1_, k1_mul,
